...
export default function ChatError({ error, reset }: { error: Error; reset: () => void }): JSX.Element {
  return (
    <section className="mx-auto max-w-3xl rounded-xl border border-danger/40 bg-danger/10 p-6" role="alert">
      <h2 className="text-lg font-semibold text-danger">Chat route failed to load</h2>
